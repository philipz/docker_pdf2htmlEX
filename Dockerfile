...
RUN yum -y remove cmake gcc gnu-getopt java-1.8.0-openjdk libpng-devel libspiro-devel freetype-devel poppler-data libjpeg-turbo-devel git make gcc-c++ && yum clean all
CMD ["bash"]
